...
<body>
  <div class="container my-5">
    ...
    <form method="POST" action="../controladores/editarPaciente.php?ide=<?php echo $row['id_paciente']; ?>">
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="especie" name="especie" maxlength="100" required value="<?php echo $row['especie']; ?>"/>
      </div>
      <div class="mb-3">
        <label for="raza" class="form-label"><i class="fas fa-dna me-2 text-secondary"></i>Raza</label>
        <input type="text" class="form-control" id="raza" name="raza" maxlength="100" required value="<?php echo $row['raza']; ?>"/>
      </div>
      <div class="mb-3">
        <label for="fecha_nac" class="form-label"><i class="fas fa-calendar-alt me-2 text-secondary"></i>Fecha de Nacimiento</label>
        <input type="date" class="form-control" id="fecha_nac" name="fecha_nac" required value="<?php echo $row['fecha_nac']; ?>"/>
      </div>
      ...
      <div class="mb-3">
        ...
        <option value="<?php echo $row['id_dueño']; ?>"> Seleccione... </option>
          <?php
            include('../modelo/conexion.php');
